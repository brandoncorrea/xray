...
**YOU ARE IN: `xray/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/xray/` (rig root) or other directories
...
**Your mail address:** `xray/polecats/chrome`
**Your rig:** xray
**Your Witness:** `xray/witness`
...
| Ask Witness for help | `gt mail send xray/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`xray/witness`) when:
...
```bash
gt mail send xray/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
